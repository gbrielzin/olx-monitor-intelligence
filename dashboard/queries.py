...
def carregar_coletas(dias: int = 7, categoria: str | None = None) -> pd.DataFrame:
    """Histórico de rodadas de coleta (1 linha por rodada/categoria) --
    ...
    total_anuncios vs média histórica) pra decidir se descarta a rodada --
    só que visível aqui, em vez de só virar alerta no Telegram quando
    falha."""
...
def carregar_novidades(dias: int = 1, categoria: str | None = None) -> pd.DataFrame:
